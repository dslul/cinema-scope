 ...
 *
 * We don't want our scope's code to be mixed together with HTTP and JSON
 *handling.
 */
class Client {
  public:
    ...
    */
    ...
    virtual FilmRes query_films(const std::string &movie_or_tv,
                                const std::string &query, int querytype,
    ...
    progress_report(const core::net::http::Request::Progress &progress);
